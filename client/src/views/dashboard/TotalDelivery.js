...
const TotalDelivery = ({ totalDelivery }) => {
  return (
    <>
      <h6>Total Delivery (L)</h6>
      <CRow>
        {totalDelivery?.isLoading
          ? [...Array(3)].map((_, index) => (
              <CCol key={index}>
                <Skeleton
          ...
          : totalDelivery?.data?.map((item, index) => {
              return (
                    ...
                    <div className={item.classname + ' card order-card'}>
                      <div className="card-block">
                        ...
                        <h2 className="m-b-0">
                          ...
                          <span className="f-right">{item.delivery}</span>
                        </h2>
                      </div>
                    </div>
                  </CCol>
