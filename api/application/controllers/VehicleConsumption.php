...
class VehicleConsumption extends RestController
{
	...
	function __construct()
	{
		...
		parent::__construct();
		$this->load->model('VehicleConsumptionModel');
	...
	{
		$vehicleConsumptionModel = new VehicleConsumptionModel;
		$result = $vehicleConsumptionModel->get();
